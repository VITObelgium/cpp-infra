...
set(SHA_SUM 9c016788478d15155d8be69eac2988a31bd59bd8dc6ef440cef71c833a3f9563cdb37e6c9b2219eb416f9e11bed199268469e15f3228c520dc6e74f1ce2fdbf3)
...
foreach(BUILD_TYPE debug release)
    ...
    vcpkg_apply_patches(
        SOURCE_PATH ${CURRENT_BUILDTREES_DIR}/src-${TARGET_TRIPLET}-${BUILD_TYPE}/${PACKAGE_NAME}
        PATCHES
    ...
    vcpkg_replace_string(
        ${CURRENT_BUILDTREES_DIR}/src-${TARGET_TRIPLET}-${BUILD_TYPE}/${PACKAGE_NAME}/configure
        "GDAL_PREFIX=\${prefix}"
    ...
    if (MINGW)
        ...
        vcpkg_replace_string(
            ${CURRENT_BUILDTREES_DIR}/src-${TARGET_TRIPLET}-${BUILD_TYPE}/${PACKAGE_NAME}/GNUmakefile
            "$(GDAL_ROOT)"
            "."
        )
    endif ()
...
file(INSTALL ${CMAKE_CURRENT_LIST_DIR}/FindGdal.cmake DESTINATION ${CURRENT_PACKAGES_DIR}/share/cmake)
