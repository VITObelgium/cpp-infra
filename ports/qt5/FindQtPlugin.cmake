...
function(find_qtplugin)
    ...
    if (${find_qtplugin_NAME}_LIBRARY)
        string(REGEX REPLACE "(.*)\.(a|lib)$"  "\\1.prl" plugin_prl_file "${${find_qtplugin_NAME}_LIBRARY}")
        ...
        vcpkg_process_prl_file_plugin(${find_qtplugin_NAME} ${plugin_prl_file} RELEASE)
    endif()

    if (${find_qtplugin_NAME}_LIBRARY_DEBUG)
        string(REGEX REPLACE "(.*)\.(a|lib)$"  "\\1.prl" plugin_prl_file "${${find_qtplugin_NAME}_LIBRARY_DEBUG}")
        ...
        vcpkg_process_prl_file_plugin(${find_qtplugin_NAME} ${plugin_prl_file} DEBUG)
    endif()
endfunction()
