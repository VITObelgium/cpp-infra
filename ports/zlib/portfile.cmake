...
if(VCPKG_LIBRARY_LINKAGE STREQUAL static)
    ...
    if(EXISTS ${CURRENT_PACKAGES_DIR}/lib/libzlibstatic.a)
        file(RENAME ${CURRENT_PACKAGES_DIR}/lib/libzlibstatic.a ${CURRENT_PACKAGES_DIR}/lib/libz.a)
    endif()
    if(EXISTS ${CURRENT_PACKAGES_DIR}/debug/lib/libzlibstaticd.a)
        file(RENAME ${CURRENT_PACKAGES_DIR}/debug/lib/libzlibstaticd.a ${CURRENT_PACKAGES_DIR}/debug/lib/libzd.a)
    endif()
endif()
