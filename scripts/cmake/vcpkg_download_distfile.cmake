...
function(vcpkg_download_distfile VAR)
    ...
    set(oneValueArgs FILENAME SHA512 TIMEOUT)
    ...
    if (vcpkg_download_distfile_TIMEOUT)
        set(download_file_timeout_secs ${vcpkg_download_distfile_TIMEOUT})
    else ()
        set(download_file_timeout_secs 1200)
    endif ()
    ...
    if(EXISTS "${downloaded_file_path}")
        ...
        if(_VCPKG_DOWNLOAD_TOOL STREQUAL "ARIA2" AND NOT SAMPLE_URL MATCHES "aria2")
            ...
            foreach(url IN LISTS vcpkg_download_distfile_URLS)
                ...
                file(DOWNLOAD ${url} "${download_file_path_part}" TIMEOUT ${download_file_timeout_secs} STATUS download_status)
