...
bool _checkMatch( TiXmlElement *el, const std::vector<std::string>& attrNames, const std::vector<std::string>& attrValues ) {
...
TiXmlElement* XmlTools::getElementByAttribute( TiXmlElement* parent, const std::string& childName,
...
TiXmlElement* XmlTools::getElementByAttributes( TiXmlElement *parent, const std::string &childName,
...
TiXmlElement * XmlTools::getElement(TiXmlElement* parent, const std::string& childName, TiXmlDocument* refDoc) {
