%MAKE_GEOTIFF_OPTION  GUI to generate 'option' argument for geotiffwrite program
%
...
%
%  With this make_geotiff_option.m program, you will find that it is a lot easier to
...
%  them.
%
%  Usage:  [option bbox] = make_geotiff_option([bbox]);
%          geotiffwrite(filename, bbox, image, [bit_depth, option]);
%
%  Example:  [option bbox] = make_geotiff_option;
...
%
function [opt, bbox] = make_geotiff_option(action)
...
function init(bbox)
   ...
   c = uicontrol('Parent',h0, ...
	...
	'value',2, ...
   	'callback','make_geotiff_option(''modeltype'');', ...
...
'user-defined'};
   ...
   c = uicontrol('Parent',h0, ...
   	...
   	'FontSize',fnt, ...
        'Position',pos, ...
        'String','OK', ...
   	'Callback','make_geotiff_option(''ok'');', ...
   	'Tag','');
   ...
   c = uicontrol('Parent',h0, ...
   	...
   	'FontSize',fnt, ...
        'Position',pos, ...
        'String','Cancel', ...
   	'Callback','make_geotiff_option(''cancel'');', ...
   	'Tag','');
