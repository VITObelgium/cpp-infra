if(NOT _VCPKG_WINDOWS_ONEAPI_TOOLCHAIN)
    ...
    set(CMAKE_CXX_FLAGS " /nologo /DWIN32 /D_WINDOWS /fp:precise ${CHARSET_FLAG} /GR /EHsc ${MP_BUILD_FLAG}${VCPKG_CXX_FLAGS}" CACHE STRING "")
    set(CMAKE_C_FLAGS " /nologo /DWIN32 /D_WINDOWS /fp:precise ${CHARSET_FLAG} ${MP_BUILD_FLAG}${VCPKG_C_FLAGS}" CACHE STRING "")
